            ...
            return new Promise((resolve, reject) => {
                data.receiver.forEach(async function (receiver) {
                    ...
                    if (receiver != data.sender) {
                        if (data.tag == "welcome") {
                            data.title = data.points + " CarEager points added to your account";
                        }
                            ...
                            data.title = sender.name + " booked a service appointment";
                        }
                            ...
                            data.title = data.points + " CarEager points deducted from your account";
                        }
                        else if (data.tag == "postDelete") {
                            data.title = data.points + " CarEager points deducted from your account";
                        }
                        else if (data.tag == "bookingConfirmed") {
                            data.title = data.points + " CarEager points added to your account";
                        }
                        ...
                        Notification.create(data).then(async function (notification) {
                            ...
                            user.device.forEach(function (device) {
                                ...
                                var payloadOK = {
                                    ...
                                    /*notification: { 
                                        title: _.startCase(notification.tag) , body: notification.title, sound : "default", badge: "1", source: notification.source, tag: notification.tag
                                    }*/
                                };
